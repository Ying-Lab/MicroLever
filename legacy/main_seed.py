...
from data_loader_DM import create_loaders   # 需按实际文件名修改
...
CONFIG = {
    "data": {
        "h5_path": "/home/data/FMT/data/train_globalR_500_4w_1026/FMT_structured_data.h5",
        "adjacency_path": "/home/data/FMT/data/Mij/adjacency_matrix.csv",
        "cdiff_label_path": "/home/data/FMT/data/train_globalR_500_4w_1026/csv_reports/Cdiff_labels_table.csv",
        "donor_final_path": "/home/data/FMT/data/train_globalR_500_4w_1026/csv_reports/donor_final_abundance.csv",
        ...
        "topology_corruption": {"mode": "none",            # "none" | "sign" | "value" | "both"
                                "rates": {"train": 0.0,
                                          ...
                                          "test":  0.0}},
        # ---- 新测试集 ----
        "new_h5_path": "/home/data/FMT/data/test_globalR_100_4w_1026/FMT_structured_data.h5",
        "new_cdiff_label_path": "/home/data/FMT/data/test_globalR_100_4w_1026/csv_reports/Cdiff_labels_table.csv",
        "new_donor_final_path": "/home/data/FMT/data/test_globalR_100_4w_1026/csv_reports/donor_final_abundance.csv",
...
def setup_env(cfg):
    ...
    for k in ("root_dir", "log_dir", "model_dir", "result_dir"):
        p = os.path.join(cfg["output"]["root_dir"], exp_time, cfg["output"][k])
